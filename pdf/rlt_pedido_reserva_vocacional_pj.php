...
$l=7; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 10);
   $pdf->MultiCell(180,$l,utf8_decode("À vista do contido às fls. retro e, uma vez que se trata de recursos transferidos da Secretaria Municipal de Educação,  encaminhamos o presente para providências de Vossa Senhoria."));
