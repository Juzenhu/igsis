...
$l=7; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->Cell(180,5,utf8_decode("Folha de Informação nº ____________"),0,1,'R');
   ...
   $pdf->Cell(122,$l,"Em: __________ / __________ / " .$ano.".",0,1,'R');
   ...
   $pdf->Cell(50,$l,utf8_decode("DESPACHO"),0,1,'L');
