	<div class="menu-area">
			<div id="dl-menu" class="dl-menuwrapper">
						...
						<ul class="dl-menu">
							<li>
								<a href="?perfil=evento&p=basica">Voltar para evento</a>
							</li>
							<li><a href="?perfil=cinema&p=listar">Listar filmes</a></li>
							<li><a href="?perfil=cinema&p=inserir">Inserir filme</a></li>
	  		...
	  		<div class="row">
				...
				<form class="form-horizontal" role="form" action="?perfil=cinema&p=editar" method="post">
				  ...
				  <div class="form-group">
					...
					<div class=" col-md-6"><strong>Minutagem:</strong><br/>
...
if(isset($_POST['carregarFilme'])){ // Carrega filme para edição
				...
				<form class="form-horizontal" role="form" action="?perfil=cinema&p=editar" method="post">
				  ...
				  <div class="form-group">
					...
					<div class=" col-md-6"><strong>País de origem (co-produção):</strong><br/>
                       ...
                       <option value="0">Não há</option>
					   <?php
						geraOpcao("ig_pais",$filme['ig_pais_IdPais_2'],"");
						?>  
					  </select>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>Classificação etária:</strong><br/>
					   <select class="form-control" id="classificacao" name="classificacao" >
                        <?php
						geraOpcao("ig_etaria",$filme['indicacaoEtaria'],"");
						?>  
					  </select>
					</div>				  
					<div class=" col-md-6"><strong>Link para trailer</strong><br/>
					 					  <input type="text" class="form-control" id="link" name="link" placeholder="link"<?php echo $filme['linkTrailer']; ?>>
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
...
if(isset($_POST['dataInicio'])){ //carrega as variaveis vindas do POST
	...
	if(isset($_POST['idCinema'])){ //Tipo de Ocorrência de Cinema
		$tipoOcorrencia = 5;	
            ...
            <form method="POST" action="?perfil=cinema&p=ocorrencias&action=listar" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                	<div class="col-md-offset-2 col-md-8">
						...
						<input type="hidden" name="idCinema" value="<?php echo $_POST['idCinema'] ?>" />
...
<?php
	break;
	case "listar":
	$filme = recuperaDados("ig_cinema",$_POST['idCinema'],"idCinema"); //retorna dados do filme
?>
	...
	<section id="list_items" class="home-section bg-white">
		<div class="container">
				  ...
				  <div class="col-md-offset-2 col-md-8">
					<div class="section-heading">
					 <h4><?php echo $filme['titulo']; ?> <?php print_r($_POST); ?></h4>
					 <p><p>
                    <h5><?php if(isset($mensagem)){echo $mensagem;} ?></h5>
                 </div>
			...
			<div class="table-responsive list_info">
                         <?php listaOcorrenciasCinema($_POST['idCinema']); ?>
			</div>
		</div>
		<form method="POST" action="?perfil=cinema&p=ocorrencias&action=inserir" class="form-horizontal" role="form">
					<div class="form-group">
                	<div class="col-md-offset-2 col-md-8">
                    	<input type="hidden" name="idCinema" value="<?php echo $filme['idCinema']; ?>"  />
                		<input type="submit" class="btn btn-theme btn-lg btn-block" value="Inserir nova ocorrência"  />
               		 </div>
                </div>
                </form>
	</section>
...
<?php
	...
	$filme = recuperaDados("ig_cinema",$_POST['idCinema'],"idCinema");
?>
<script type="application/javascript">
$(function(){
	$('#instituicao').change(function(){
