...
$update = "UPDATE pedido_contratacao_pj 
			SET 
			Objeto = '$objeto',
...
$stmt = mysqli_prepare($conexao,$update);
 ...
 if(mysqli_stmt_execute($stmt))
	 ...
	 <a href='$link1?id_ped=$id_ped'><button>Artistico</button></a><br />
	 <a href='$link2?id_ped=$id_ped'><button>Padrao</button></a><br />
	 <a href='$link3?id_ped=$id_ped'><button>Vocacional</button></a><br />
	 <br /></center>";
