	  ...
	  <section id="contact" class="home-section bg-white">
	  	<div class="container">
			  <div class="form-group">
					<div class="sub-title"><h2>PROPOSTA PESSOA FÍSICA</h2></div>
			  </div>

	  		<div class="row">
	  			<div class="col-md-offset-1 col-md-10">

				<form class="form-horizontal" role="form" action="?perfil=contratos&p=update_proposta_pf&id_ped=<?php echo $_GET['id_ped']; ?>" method="post">
				 <div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Código do Pedido de Contratação:</strong><br/>
					  <input type="text" class="form-control" id="IdPedidoContratacaoPF" name="IdPedidoContratacaoPF" <?php echo "value='$ano-$id_ped'";?>>
					</div>
				  </div>
