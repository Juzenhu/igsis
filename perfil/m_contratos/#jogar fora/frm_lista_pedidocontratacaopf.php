...
$linha_tabela_lista = siscontratLista(1,5,10,1,"DESC", "000001"); //esse gera uma array com os pedidos
...
for($i = 0; $i < count($linha_tabela_lista); $i++)
 {
	$linha_tabela_pedido_contratacaopf = siscontratDocs($linha_tabela_lista[$i]['IdProponente'],1);	 
