<?php 
   ...
   // ARQUIVO COM AS FUNÇÕES DO SISCONTRAT
...
$codPed = $pedido["Id_PedidoContratacaoPF"]; // verificar protocolo
...
$NomeArtistico = $executante["NomeArtistico"];
$EstadoCivil = $executante["EstadoCivil"];
$Nacionalidade = $executante["Nacionalidade"];
$RG = $executante["RG"];
$CPF = $executante["CPF"];
$CCM = $executante["CCM"];
$OMB = $executante["OMB"];
$DRT = $executante["DRT"];
$Funcao = $executante["Funcao"];
$Endereco = $executante["Endereco"];
$Telefones = $executante["Telefones"];
$Email = $executante["Email"];
$INSS = $executante["InscricaoINSS"];

$RazaoSocial = $pj["Nome"]; // Ver com o Marcio se isto está certo
$CCM = $pj["CCM"];
$CNPJ = $pj["CNPJ"];
...
$Representante01 = $representante["Nome"];
